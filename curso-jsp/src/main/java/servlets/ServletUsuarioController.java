	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (acao != null && !acao.isEmpty() && acao.equalsIgnoreCase("deletar")) {
				...
				relatorio = new ReportUtil().geraRelatorioPDF(modelLogins, "resl-user-jsp", params, request.getServletContext());
				extensal = "pdf";
				} else 
					if(acao.equalsIgnoreCase("imprimirRelatorioExcel")) {
						relatorio = new ReportUtil().geraRelatorioExcel(modelLogins, "resl-user-jsp", params, request.getServletContext());
						extensal = "xls";	
					}
